...
(t/run-tests 'app-otent.scene-test 'app-otent.route-test 'app-otent.propagate-test 'app-otent.db-test 'app-otent.views-test 'app-otent.iceberg-test 'app-otent.objects-test)
